...
plot(feb1_and_feb2_data$date_time,as.numeric(feb1_and_feb2_data$Global_active_power),type = "l",xlab = "datetime",ylab ="Global active power (Kilowatts)")

plot(feb1_and_feb2_data$date_time,as.numeric(feb1_and_feb2_data$Voltage),type = "l",xlab = "datetime",ylab ="Voltage")


with(feb1_and_feb2_data,plot(date_time,as.numeric(feb1_and_feb2_data$Sub_metering_1),type="l",col="black",xlab="datetime",ylab="Energy sub metering"))
...
plot(feb1_and_feb2_data$date_time,as.numeric(feb1_and_feb2_data$Global_reactive_power),type = "l",xlab = "datetime",ylab ="Global reactive power")
